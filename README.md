...
This repository contains samples related to **Structured Output** and **structured generation** with the OpenAI API:

- **[structured_output/](structured_output/)** — JSON Schema structured outputs (contract & employee data extraction from PDFs).
